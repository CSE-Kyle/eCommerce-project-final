...
router.get("/", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
    var category, keywordSearch, orderSort, products;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            orderSort = req.query.orderSort ? req.query.orderSort === 'low' ? {
              price: 1
            } : {
              price: -1
            } : {
            ...
            _context.next = 5;
            return _productModel["default"].find(_objectSpread(_objectSpread({}, category), keywordSearch)).sort(orderSort);
